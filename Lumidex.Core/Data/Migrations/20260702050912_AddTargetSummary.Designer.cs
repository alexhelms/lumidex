...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lumidex.Core.Data.AppSettings", b =>
                {
                    ...
                    b.Property<bool>("PersistFiltersOnExit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);

                    b.Property<bool>("UseIntermediateFramesForPlots")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Lumidex.Core.Data.AstrobinFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Lumidex.Core.Data.PersistedFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PersistedFilters");
                });

            modelBuilder.Entity("Lumidex.Core.Data.ScopeMerge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("AbsorbedName")
                        .IsUnique();

                    b.ToTable("ScopeMerges");
                });
            ...
            modelBuilder.Entity("Lumidex.Core.Data.Target", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Lumidex.Core.Data.TargetFilterGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TargetId", "Scope", "Filter")
                        .IsUnique();

                    b.ToTable("TargetFilterGoals");
                });

            modelBuilder.Entity("Lumidex.Core.Data.TargetMerge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("AbsorbedLabel")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<int>("AbsorbedTargetId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("SurvivorLabel")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<int>("SurvivorTargetId")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.HasIndex("AbsorbedTargetId")
                        .IsUnique();

                    b.ToTable("TargetMerges");
                });

            modelBuilder.Entity("Lumidex.Core.Data.TargetNameMap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("RawObjectName")
                        .IsRequired()
                        .HasColumnType("TEXT COLLATE NOCASE");
                    ...
                    b.HasIndex("RawObjectName")
                        .IsUnique();

                    b.HasIndex("TargetId");

                    b.ToTable("TargetNameMaps");
                });
            ...
            modelBuilder.Entity("Lumidex.Core.Data.AstrobinFilter", b =>
                {
                    b.HasOne("Lumidex.Core.Data.AppSettings", "AppSettings")
                        .WithMany("AstrobinFilters")
            ...
            modelBuilder.Entity("Lumidex.Core.Data.TargetFilterGoal", b =>
                {
                    b.HasOne("Lumidex.Core.Data.Target", "Target")
                        .WithMany()
            ...
            modelBuilder.Entity("Lumidex.Core.Data.AppSettings", b =>
                {
                    b.Navigation("AstrobinFilters");

                    b.Navigation("PersistedFilters");
                });

            modelBuilder.Entity("Lumidex.Core.Data.Target", b =>
                {
                    b.Navigation("NameMaps");
                });
